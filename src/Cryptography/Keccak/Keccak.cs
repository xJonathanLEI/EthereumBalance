...
namespace EthereumBalance.Cryptography
{
    public abstract class Keccak : System.Security.Cryptography.HashAlgorithm
    {
        #region Statics
        public static string DefaultHashName = "SHA512";

        protected static Dictionary<string, Func<Keccak>> HashNameMap;

        static Keccak()
        {
            HashNameMap = new Dictionary<string, Func<Keccak>>
            {
                //{ "Keccak-224", () => { return new Keccak224(); } }
